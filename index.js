const contentLetterSrart_actived = "Gửi chị Camy!! Mong chị đọc xong bức thư này sẽ bớt buồn lại và hãy vui lên"
const mainContentLetter = "Chúc chị Camy sinh nhật tuổi mới vui vẻ, chị Camy hãy vui vẻ lên đi, chúng ta có rất nhiều điều mà chúng ta cần thực hiện, chúng ta nên chấp nhận và trân trọng những gì đến và đi đối với cuộc sống. Thế nên, sinh nhật chị thì hãy vui lên, chúc chị Camy luôn xinh đẹp, vui vẻ, mạnh khỏe như trâu. NẾU CHỊ CÓ BUỒN THÌ CHỊ ĐỪNG BUỒN NỮA! :D CHỊ ĐÃ ĐỠ BUỒN CHƯA :D "
